...
embed=discord.Embed(title="Nuke!", url="https://github.com/Anonyme/Nuke!", description="Voici la liste des commandes disponibles : ", color=0x000000)
...
embed.set_footer(text="Nuke! | Anonyme")

link = "discord.gg/9fAsey7SxX"

token = input("Token du bot > ")



spam = "`` J'tai raid vieux FDP.`` @everyone  "

username = "Anonyme#0000"

nombre_spam = True

nom_salons = "RAID BY ANONYME !"
nombre_salons = 30

nom_roles = "RAID BY ANONYME 👑"
nombre_roles = 10

nom_serveur = "J'tai Raid Fdp 😘"
...
pour augmenter le nombre de messages envoyés, envoyer [!spam] plusieurs fois""")
    activity = discord.Game(name="EZ", type=1)
...
async def on_message(message):
    ...
    if message.content == "!help":
        ...
        await message.channel.send("Je vous ai envoyé le lien permettant d'apprendre à raid un serveur en privé ^^")
